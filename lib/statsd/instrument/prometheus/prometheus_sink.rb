  ...
  module Instrument
    module Prometheus
      class PrometheusSink < ::StatsD::Instrument::UDPSink
        ...
        def initialize(addr, auth_key, percentiles, application_name, subsystem, default_tags, open_timeout, read_timeout, write_timeout, basic_auth_user, histograms, hostname) # rubocop:disable Lint/MissingSuper
